...
export default defineConfig({
    ...
    themeConfig: {
        ...
        nav: [
            {text: '首页', link: '/'},
            {text: '前端笔记', link: '/markdown-examples'},
            {text: '后端笔记', link: '/markdown-examples'},
            {text: 'All-In-One', link: '/markdown-examples'},
            {text: '私人笔记', link: '/markdown-examples'}
        ],
        ...
        sidebar: [
            {
                text: '前端笔记',
                items: [
                    {text: 'Markdown Examples', link: '/markdown-examples', collapsed: true},
